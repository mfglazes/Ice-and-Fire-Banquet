...
public class DragonLightningStoveBlockEntity extends SyncedBlockEntity {
    ...
    public DragonLightningStoveBlockEntity(BlockPos pos, BlockState state) {
        super(ModEntities.DRAGON_LIGHTNING_STOVE.get(), pos, state);
    }
    ...
    // 核心烹饪逻辑（服务端）
    public static void cookingTick(Level level, BlockPos pos, BlockState state, DragonLightningStoveBlockEntity stove) {
    ...
    public static void animationTick(Level level, BlockPos pos, BlockState state, DragonLightningStoveBlockEntity stove) {
        for (int i = 0; i < stove.inventory.getSlots(); ++i) {
