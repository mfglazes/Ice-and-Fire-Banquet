...
public class IceDragonSteelKnife extends KnifeItem implements DragonSteelOverrides<IceDragonSteelKnife> {
    ...
    public IceDragonSteelKnife(Tier tier, float attackDamageModifier, float attackSpeedModifier, Properties properties) {
    ...
    public void releaseUsing(ItemStack stack, Level level, LivingEntity entity, int timeLeft) {
        ...
        EntityDragonIceCharge charge = null;
        if (!level.isClientSide) {
            // 创建火龙龙息弹实体
            charge = new EntityDragonIceCharge(
                    IafEntityRegistry.ICE_DRAGON_CHARGE.get(),
                    level,
        ...
        level.playSound(null,
                ...
                SoundEvents.GLASS_BREAK,  // 可根据需要换成自定义音效
                SoundSource.PLAYERS,
                1.0F,
