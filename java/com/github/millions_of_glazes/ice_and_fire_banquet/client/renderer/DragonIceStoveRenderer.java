...
public class DragonIceStoveRenderer implements BlockEntityRenderer<DragonIceStoveBlockEntity> {

    private static final float ITEM_SIZE = 0.375F;

    public DragonIceStoveRenderer(BlockEntityRendererProvider.Context context) {
    }

    @Override
    public void render(DragonIceStoveBlockEntity stove, float partialTicks, PoseStack poseStack,
