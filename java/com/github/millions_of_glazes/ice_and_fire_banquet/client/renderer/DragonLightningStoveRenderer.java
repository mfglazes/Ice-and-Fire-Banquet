...
public class DragonLightningStoveRenderer implements BlockEntityRenderer<DragonLightningStoveBlockEntity> {

    private static final float ITEM_SIZE = 0.375F;

    public DragonLightningStoveRenderer(BlockEntityRendererProvider.Context context) {
    }

    @Override
    public void render(DragonLightningStoveBlockEntity stove, float partialTicks, PoseStack poseStack,
